...
// How to play modal
const htpBackdrop = document.getElementById('htpBackdrop');
const htpOpenBtn = document.getElementById('howToPlayBtn');
const htpCloseBtn = document.getElementById('htpClose');
const htpGotItBtn = document.getElementById('htpGotIt');

function openHowToPlay() {
  htpBackdrop.classList.add('show');
}

function closeHowToPlay() {
  htpBackdrop.classList.remove('show');
}

htpOpenBtn.addEventListener('click', openHowToPlay);
htpCloseBtn.addEventListener('click', closeHowToPlay);
htpGotItBtn.addEventListener('click', closeHowToPlay);
htpBackdrop.addEventListener('click', e => {
  if (e.target === htpBackdrop) closeHowToPlay();
});
